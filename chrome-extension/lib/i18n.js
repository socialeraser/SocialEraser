...
(function() {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      following: 'Following',
      // Tweets 子选项 UI
      tweetsOptions: 'Tweets options',
      includeReplies: 'Include replies',
      includeRetweets: 'Include retweets',
      includeRepliesHint: 'Also delete replies to other tweets',
      includeRetweetsHint: 'Also undo reposts (not delete)',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: 'Starting tweets cleanup on {url}...',
    ...
    'zh-CN': {
      ...
      includeReplies: '含回复',
      includeRetweets: '含转发',
      includeRepliesHint: '同时删除回复给其他人的推文',
      includeRetweetsHint: '同时撤销转发（不删除）',
      filterOptions: '筛选条件',
      fromDate: '开始日期',
      toDate: '结束日期',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: '开始清理推文：{url}',
      noMoreTweets: '无更多推文',
      endOfTweets: '推文清理完成',
    ...
    'zh-TW': {
      ...
      bookmarks: '書籤',
      following: '追蹤',
      // Tweets 子选项 UI（缩进后不再需要标题）
      includeReplies: '含回覆',
      includeRetweets: '含轉發',
      includeRepliesHint: '同時刪除回覆給其他人的推文',
      includeRetweetsHint: '同時撤銷轉發（不刪除）',
      filterOptions: '篩選條件',
      fromDate: '開始日期',
      toDate: '結束日期',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: '開始清理推文：{url}',
      noMoreTweets: '無更多推文',
      endOfTweets: '推文清理完成',
    ...
    ja: {
      ...
      following: 'フォロー',
      // Tweets 子选项 UI
      tweetsOptions: 'ツイート オプション',
      includeReplies: '返信を含む',
      includeRetweets: 'リツイートを含む',
      includeRepliesHint: '他の人への返信も削除する',
      includeRetweetsHint: 'リツイートも取り消す（削除ではない）',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: 'ツイートをクリーンアップ中：{url}',
    ...
    ko: {
      ...
      includeRepliesHint: '다른 사용자에게 보낸 답글도 삭제',
      includeRetweetsHint: '리트윗도 취소 (삭제 아님)',
      filterOptions: '필터 옵션',
      fromDate: '시작일',
      toDate: '종료일',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: '트윗 정리 시작: {url}',
    ...
    es: {
      ...
      following: 'Siguiendo',
      // Tweets 子选项 UI
      tweetsOptions: 'Opciones de tweets',
      includeReplies: 'Incluir respuestas',
      includeRetweets: 'Incluir retweets',
      includeRepliesHint: 'También eliminar respuestas a otros tweets',
      includeRetweetsHint: 'También deshacer reposts (no eliminar)',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: 'Iniciando limpieza de tweets en {url}...',
    ...
    de: {
      ...
      following: 'Folge ich',
      // Tweets 子选项 UI
      tweetsOptions: 'Tweet-Optionen',
      includeReplies: 'Antworten einschließen',
      includeRetweets: 'Retweets einschließen',
      includeRepliesHint: 'Auch Antworten an andere löschen',
      includeRetweetsHint: 'Auch Reposts rückgängig machen (nicht löschen)',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: 'Tweet-Bereinigung auf {url} wird gestartet...',
    ...
    fr: {
      ...
      // Tweets 子选项 UI
      tweetsOptions: 'Options de tweets',
      includeReplies: 'Inclure les réponses',
      includeRetweets: 'Inclure les retweets',
      includeRepliesHint: 'Supprimer aussi les réponses aux autres',
      includeRetweetsHint: 'Annuler aussi les reposts (pas supprimer)',
      ...
      // Tweets 清理日志 + 提示
      startingTweetsCleanup: 'Nettoyage des tweets sur {url}...',
