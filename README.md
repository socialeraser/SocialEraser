...
| **login status 实时检测** | ✅ | content.js 每 3s 轮询 checkLoginStatus，状态变化时广播 statusUpdate 给 sidepanel，修复"SPA 登录后 sidepanel 一直显示 Not logged in" |
...
node scripts/verify-i18n.js        # i18n 8 语言 × 12 keys = 96 entries 完整性
...
```json
{
  "selectors": {
    ...
    "tweet": { "container": "...", "moreButtons": [...], "deleteButton": "...", "confirmButton": "..." },
    "like": { "container": "...", "unlikeButtons": [...] },
    "bookmark": { "container": "...", "removeButtons": [...] },
    "following": { "container": "...", "unfollowButton": "...", "confirmButton": "..." }
  }
}
```
