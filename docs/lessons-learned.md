# SocialEraser 项目经验（Lessons Learned）
...
function incrementDailyUsage(count, callback) {
  _dailyUsageChain = _dailyUsageChain.then(function() {
    ...
    console.warn('[SocialEraser] incrementDailyUsage chain step failed:', err.message);
...
#### 1. 新增 8 语言常量（[chrome-extension/lib/injector.js 第 67-99 行](file:///Volumes/XPSSD/workspaces/SocialEraser/chrome-extension/lib/injector.js)）
...
[scripts/verify-actual-x-selectors.js 第 11 节](file:///Volumes/XPSSD/workspaces/SocialEraser/scripts/verify-actual-x-selectors.js) 锁 6 个断言：
...
#### 1. 提取 `DEFAULT_I18N` 常量（[chrome-extension/lib/injector.js 第 67-148 行](file:///Volumes/XPSSD/workspaces/SocialEraser/chrome-extension/lib/injector.js)）
...
#### 2. setConfig 末尾合并 i18n（[chrome-extension/lib/injector.js 第 211-227 行](file:///Volumes/XPSSD/workspaces/SocialEraser/chrome-extension/lib/injector.js)）
...
#### 4. 远程配置加 i18n section（[chrome-extension/config/remote-example.json](file:///Volumes/XPSSD/workspaces/SocialEraser/chrome-extension/config/remote-example.json)）
...
[scripts/verify-actual-x-selectors.js 第 12-13 节](file:///Volumes/XPSSD/workspaces/SocialEraser/scripts/verify-actual-x-selectors.js) 锁 **50+ 个新断言**：
...
**修复**：[lib/injector.js collectCandidates addAll](file:///Volumes/XPSSD/workspaces/SocialEraser/chrome-extension/lib/injector.js#L1112-L1123) 加 6 行 filter：btn 必须有 `closest('article')` 或 `findClosest(articleContainers)` 祖先。
...
- 完整 session：[docs/debug-history/debug-tweet-reply-broken.md](file:///Volumes/XPSSD/workspaces/SocialEraser/docs/debug-history/debug-tweet-reply-broken.md)
...
完整归档列表：
- [docs/debug-history/debug-login-stuck-checking.md](file:///Volumes/XPSSD/workspaces/SocialEraser/docs/debug-history/debug-login-stuck-checking.md) → 案例 12
- [docs/debug-history/debug-tweet-delete-broken.md](file:///Volumes/XPSSD/workspaces/SocialEraser/docs/debug-history/debug-tweet-delete-broken.md) → 案例 13
- [docs/debug-history/debug-tweet-reply-broken.md](file:///Volumes/XPSSD/workspaces/SocialEraser/docs/debug-history/debug-tweet-reply-broken.md) → 案例 14
- [docs/debug-history/debug-tweet-delete-regression.md](file:///Volumes/XPSSD/workspaces/SocialEraser/docs/debug-history/debug-tweet-delete-regression.md) → 案例 15
...
1. [.cursor/rules/social-eraser-spec.mdc.md](file:///Volumes/XPSSD/workspaces/SocialEraser/.cursor/rules/social-eraser-spec.mdc.md) — Cursor IDE 全局规则（alwaysApply: true，AI 每次操作都加载）
2. [.trae/skills/social-eraser-debugging/SKILL.md](file:///Volumes/XPSSD/workspaces/SocialEraser/.trae/skills/social-eraser-debugging/SKILL.md) — Trae debug skill（AI 调试时加载）
